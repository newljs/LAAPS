...
class DataReceiverTest : TestBase() {
    ...
    @Test
    fun `processIntent enqueues Aidex2Worker for AIDEX2_CGM_DATA`() {
        // Arrange
        val intent = createIntent(Intents.AIDEX2_CGM_DATA)
        whenever(dataWorkerStorage.storeInputData(any(), any())).thenReturn(androidx.work.Data.EMPTY)
        ...
        // Assert
        assertWorkerEnqueued(Aidex2Plugin.Aidex2Worker::class)
    }

    @Test
    fun `processIntent enqueues SinocareWorker for SINOCARE_PUBLIC_BG`() {
        // Arrange
        val intent = createIntent(Intents.SINOCARE_PUBLIC_BG)
        whenever(dataWorkerStorage.storeInputData(any(), any())).thenReturn(androidx.work.Data.EMPTY)
        ...
        // Assert
        assertWorkerEnqueued(SinocarePlugin.SinocareWorker::class)
    }
